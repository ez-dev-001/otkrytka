...
def send_welcome(message):
    ...
    text2="Говорят, что есть такой мальчик, который тебя очень сильно любит и поддержит в любой момент твоей жизни.\nКак по мне, он очень сомнительный, но всё равно кто его знает\n Еще меня попросили передать какие-то слова для тебя...\n\n Владуся, я знаю, что у тебя не очень настроение и всё как-то грустно, но одно я знаю точно, что ты самое счастливое, что случилось со мной и я тебя очень сильно люблю, это напоминание тебе, чтобы ты всегда занала)"
    txt_msg=bot.send_message(1409326380,text2)
    heart_loading_animation2(1409326380)
